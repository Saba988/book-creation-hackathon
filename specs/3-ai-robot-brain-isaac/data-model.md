...
### Isaac Component Entity
- **Name**: Name of the Isaac component (e.g., Isaac Sim, Isaac ROS, Nav2)
...
- Isaac Components are referenced across multiple Chapters and Sections
...
- Isaac Components must be accurately described with their actual capabilities